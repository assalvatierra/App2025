...
function _createStandaloneParametersPanel(bindingSettings) {
...
export function createStandaloneParametersPanel(bindingSettings) {
    return _createModelWithLocalization(bindingSettings, _createStandaloneParametersPanel);
}
...
function _createModelWithLocalization(bindingSettings, createModelFunc) {
