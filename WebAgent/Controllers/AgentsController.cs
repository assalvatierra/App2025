...
namespace WebAgent.Controllers
{
    public class AgentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Roles")] Agent agent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Roles")] Agent agent)
        {
            if (id != agent.Id)
            {
                return NotFound();
