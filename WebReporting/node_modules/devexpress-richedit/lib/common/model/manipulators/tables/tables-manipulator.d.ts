...
export declare class TablesManipulator extends BaseManipulator {
    ...
    mergeSelectedTableCellsHorizontally(subDocument: SubDocument, tableInfo: SelectedTableInfo, inputPosition: InputPositionBase): void;
    mergeSelectedTableCellsVertically(subDocument: SubDocument, tableInfo: SelectedTableInfo, inputPosition: InputPositionBase): void;
    ...
    insertCellToTheRight(subDocument: SubDocument, table: Table, rowIndex: number, cellIndex: number, inpPos: InputPositionBase, canNormalizeTable?: boolean, canNormalizeVerticalMerging?: boolean, canCopyProperties?: boolean, needToSetNextStyle?: boolean): void;
