...
addToBindingsCache('if: $data.validationRules || $data.validatorOptions', function ($context, $element) { return { 'if': function () { return $context.$data.validationRules || $context.$data.validatorOptions; } }; });
