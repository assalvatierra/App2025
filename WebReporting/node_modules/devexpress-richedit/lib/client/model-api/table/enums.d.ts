export declare enum BorderLineStyleApi {
    Nil = -1,
    None = 0,
    Single = 1,
    Thick = 2,
...
export declare enum TableWidthTypeApi {
    Auto = 1,
    Percent = 2,
    Twips = 3
}
export declare enum TableRowHeightTypeApi {
    Minimum = 0,
    Auto = 1,
    Exact = 2
}
export declare enum TableContentHorizontalAlignmentApi {
    Left = 0,
    Right = 1,
    Center = 2
}
export declare enum TableContentVerticalAlignmentApi {
    Top = 0,
    Center = 2,
    Bottom = 3
}
