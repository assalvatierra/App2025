...
export declare class Formatter {
    ...
    private get grid();
    constructor(rowFormatter: RowFormatter, tablePositions: TablePosition[], column: LayoutColumn, tableMaxWidth: number, offset: Offset, parentCell: LayoutTableCellInfo, index: number, avaliableHeight: number, parentFormatter: Formatter, pageIndexFromWhichTableWasMoved?: number | null);
