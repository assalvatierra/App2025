...
SvgTemplatesEngine.addTemplates({
    'dxrd-rich-edit': '<div class="dxrd-width-100 dxrd-height-100" data-bind="css: rich.className"> <div data-bind="visible: rich.visible"> <!-- ko with: rich.getToolbar() --> <!-- ko template: { name: template, data: $data }--> <!-- /ko --> <!-- /ko --> </div> </div>',
    ...
    'dxrd-richEdit-toolbar-colorpicker': '<div data-bind="dxColorBox: { value: value, popupPosition: { collision: \'flipfit flipfit\' }, focusStateEnabled: false, dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>',
    'dxrd-rich-toolbar-combobox': '<div data-bind="dxLocalizedSelectBox: { dataSource: items, value: value, dropDownOptions: { container: $root.getPopupContainer($element) }, focusStateEnabled: false, searchEnabled: !supportCustomValue, displayCustomValue: true, acceptCustomValue: supportCustomValue, openOnFieldClick: !supportCustomValue }, dxValidator: { validationRules: validationRules }"></div>',
