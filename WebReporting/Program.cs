...
using WebReporting.Services;
using WebReporting.Data;
...
DevExpress.Utils.DeserializationSettings.RegisterTrustedClass(typeof(WebReporting.Employees.DataSource));
