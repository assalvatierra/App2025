...
*/
import { addDisposeCallback, getParentContainer } from '@devexpress/analytics-core/analytics-internal';
    ...
    init: function (element, valueAccessor, allBindings, viewModel, bindingContext) {
        ...
        if (model.controller && model.controller.richEdit) {
            ...
            if (ko.dataFor(_richElement) && document.getElementById(_richElement.id)) {
                ...
                ko.applyBindings({ rich: model.controller.richEdit, getPopupContainer: getParentContainer }, _richElement);
            ...
            ko.applyBindings({ rich: richEditModel, getPopupContainer: getParentContainer }, richElement);
