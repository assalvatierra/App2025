...
const Lookup = _ui.default.inherit({
    ...
    _filterDataSource() {
        if (this._list && !this._list._dataSource && this._isMinSearchLengthExceeded()) {
            var _this$_list2;
            null === (_this$_list2 = this._list) || void 0 === _this$_list2 || _this$_list2._scrollView.startLoading()
        }
    ...
    _dataSourceFiltered() {
        var _this$_list3;
        this.callBase(...arguments);
        null === (_this$_list3 = this._list) || void 0 === _this$_list3 || _this$_list3._scrollView.finishLoading()
    },
    ...
    _renderInputValue() {
        return this.callBase(...arguments).always((() => {
            this._refreshSelected()
        }))
    },
    _renderPlaceholder() {
