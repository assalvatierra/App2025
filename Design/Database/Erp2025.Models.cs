...
namespace Erp.Domain.Models
{
    ...
    public partial class Models : DbContext
    {
        ...
        public virtual DbSet<AgentInstruction> AgentInstruction
        {
            get;
            set;
        }

        public virtual DbSet<AgentBin> AgentBin
        {
            get;
            set;
        }

        public virtual DbSet<AgentFeature> AgentFeature
        {
            get;
            set;
        }

        public virtual DbSet<AgentTask> AgentTask
        {
            get;
            set;
        }

        public virtual DbSet<AgentTaskStatus> AgentTaskStatus
        {
            get;
            set;
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            this.AgentInstructionMapping(modelBuilder);
            this.CustomizeAgentInstructionMapping(modelBuilder);

            this.AgentBinMapping(modelBuilder);
            this.CustomizeAgentBinMapping(modelBuilder);

            this.AgentFeatureMapping(modelBuilder);
            this.CustomizeAgentFeatureMapping(modelBuilder);

            this.AgentTaskMapping(modelBuilder);
            this.CustomizeAgentTaskMapping(modelBuilder);

            this.AgentTaskStatusMapping(modelBuilder);
            this.CustomizeAgentTaskStatusMapping(modelBuilder);
        ...
        #region AgentInstruction Mapping

        private void AgentInstructionMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AgentInstruction>().ToTable(@"AgentInstruction");
            modelBuilder.Entity<AgentInstruction>().Property<int>(x => x.Id).HasColumnName(@"Id").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<AgentInstruction>().Property<int>(x => x.AgentId).HasColumnName(@"AgentId").ValueGeneratedNever();
            modelBuilder.Entity<AgentInstruction>().Property<string>(x => x.Title).HasColumnName(@"Title").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<AgentInstruction>().Property<string>(x => x.Content).HasColumnName(@"Content").ValueGeneratedNever().HasMaxLength(8000);
            modelBuilder.Entity<AgentInstruction>().Property<string>(x => x.keywords).HasColumnName(@"keywords").ValueGeneratedNever();
            modelBuilder.Entity<AgentInstruction>().Property<int?>(x => x.orderNo).HasColumnName(@"orderNo").ValueGeneratedNever();
            modelBuilder.Entity<AgentInstruction>().HasKey(@"Id");
        }

        partial void CustomizeAgentInstructionMapping(ModelBuilder modelBuilder);

        #endregion

        #region AgentBin Mapping

        private void AgentBinMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AgentBin>().ToTable(@"AgentBin");
            modelBuilder.Entity<AgentBin>().Property<int>(x => x.Id).HasColumnName(@"Id").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<AgentBin>().Property<int>(x => x.AgentId).HasColumnName(@"AgentId").ValueGeneratedNever();
            modelBuilder.Entity<AgentBin>().Property<string>(x => x.Data).HasColumnName(@"Data").ValueGeneratedNever().HasMaxLength(8000);
            modelBuilder.Entity<AgentBin>().Property<System.DateTime>(x => x.DtAdded).HasColumnName(@"DtAdded").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<AgentBin>().Property<int?>(x => x.OrderNo).HasColumnName(@"OrderNo").ValueGeneratedNever();
            modelBuilder.Entity<AgentBin>().Property<string>(x => x.Status).HasColumnName(@"Status").ValueGeneratedNever();
            modelBuilder.Entity<AgentBin>().HasKey(@"Id");
        }

        partial void CustomizeAgentBinMapping(ModelBuilder modelBuilder);

        #endregion

        #region AgentFeature Mapping

        private void AgentFeatureMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AgentFeature>().ToTable(@"AgentFeature");
            modelBuilder.Entity<AgentFeature>().Property<int>(x => x.Id).HasColumnName(@"Id").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<AgentFeature>().Property<int>(x => x.AgentId).HasColumnName(@"AgentId").ValueGeneratedNever();
            modelBuilder.Entity<AgentFeature>().Property<string>(x => x.Code).HasColumnName(@"Code").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<AgentFeature>().Property<string>(x => x.Options).HasColumnName(@"Options").ValueGeneratedNever();
            modelBuilder.Entity<AgentFeature>().HasKey(@"Id");
        }

        partial void CustomizeAgentFeatureMapping(ModelBuilder modelBuilder);

        #endregion

        #region AgentTask Mapping

        private void AgentTaskMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AgentTask>().ToTable(@"AgentTask");
            modelBuilder.Entity<AgentTask>().Property<int>(x => x.Id).HasColumnName(@"Id").ValueGeneratedOnAdd();
            modelBuilder.Entity<AgentTask>().Property<string>(x => x.Title).HasColumnName(@"Title").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<AgentTask>().Property<string>(x => x.Description).HasColumnName(@"Description").ValueGeneratedNever();
            modelBuilder.Entity<AgentTask>().Property<string>(x => x.MonitoredBy).HasColumnName(@"MonitoredBy").ValueGeneratedNever();
            modelBuilder.Entity<AgentTask>().Property<string>(x => x.performedBy).HasColumnName(@"performedBy").ValueGeneratedNever();
            modelBuilder.Entity<AgentTask>().Property<string>(x => x.Occurence).HasColumnName(@"Occurence").ValueGeneratedNever();
            modelBuilder.Entity<AgentTask>().Property<System.DateTime?>(x => x.DueDate).HasColumnName(@"DueDate").ValueGeneratedNever();
            modelBuilder.Entity<AgentTask>().Property<System.DateTime?>(x => x.ScheduleDate).HasColumnName(@"ScheduleDate").ValueGeneratedNever();
            modelBuilder.Entity<AgentTask>().Property<string>(x => x.NextReminder).HasColumnName(@"NextReminder").ValueGeneratedNever();
            modelBuilder.Entity<AgentTask>().Property<string>(x => x.OtherInfo).HasColumnName(@"OtherInfo").ValueGeneratedNever();
            modelBuilder.Entity<AgentTask>().Property<int>(x => x.AgentTaskStatusId).HasColumnName(@"AgentTaskStatusId").ValueGeneratedNever();
            modelBuilder.Entity<AgentTask>().HasKey(@"Id");
        }

        partial void CustomizeAgentTaskMapping(ModelBuilder modelBuilder);

        #endregion

        #region AgentTaskStatus Mapping

        private void AgentTaskStatusMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AgentTaskStatus>().ToTable(@"AgentTaskStatus");
            modelBuilder.Entity<AgentTaskStatus>().Property<int>(x => x.Id).HasColumnName(@"Id").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<AgentTaskStatus>().Property<string>(x => x.Name).HasColumnName(@"Name").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<AgentTaskStatus>().Property<int>(x => x.Active).HasColumnName(@"Active").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<AgentTaskStatus>().HasKey(@"Id");
        }

        partial void CustomizeAgentTaskStatusMapping(ModelBuilder modelBuilder);
        ...
        private void RelationshipsMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AgentInstruction>().HasOne(x => x.Agent).WithMany(op => op.Agent_instructions).IsRequired(true).HasForeignKey(@"AgentId");

            modelBuilder.Entity<AgentBin>().HasOne(x => x.Agent).WithMany(op => op.Agent_bins).IsRequired(true).HasForeignKey(@"AgentId");

            modelBuilder.Entity<AgentFeature>().HasOne(x => x.Agent).WithMany(op => op.AgentFeatures).IsRequired(true).HasForeignKey(@"AgentId");

            modelBuilder.Entity<AgentTask>().HasOne(x => x.AgentTaskStatus).WithMany().IsRequired(true).HasForeignKey(@"AgentTaskStatusId");
        }
